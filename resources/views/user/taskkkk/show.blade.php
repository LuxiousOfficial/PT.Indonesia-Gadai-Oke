                ...
                <div class="col-md-12 col-12">
                  <div class="table-responsive col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 small">
                        <table class="table table-sm text-center fs-5">
                          ...
                          <tr>
                            <td>Description</td>
                            <td>{{ $taskkkk->description }}</td>
                          </tr>
                          <tr>
                            <td>Deadline</td>
                            <td>{{ $taskkkk->deadline }}</td>
                          </tr>
                          <tr>
                            <td>Status</td>
                            <td>{{ $taskkkk->status }}</td>
                          </tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <div class="daftar text-center text-capitalize mt-5">
                      <a href="/user/taskkkk" class="fs-5 fw-bold text-decoration-none py-3 px-3 bg-warning text-light rounded">Back</a>
                    </div>
                </div>
            </div>
        </div>
